...
extern char	*malloc();		/* space allocator		*/
extern char	*prime();
extern char	*expr();
extern char	*string();
extern char	*idscan();
extern char	*resolveid();
extern LN	*tlntoln();
extern ST	*allocst();
...
char *
string( s, thisln ) reg char *s; reg LN *thisln; {
...
LN *
tlntoln( n ){		/* map n to a line entry */
...
char *
resolveid( s, thisln, gflg ) reg char *s; reg LN *thisln;{
...
char *
prime( s, thisln, gflg ) reg char *s; reg LN *thisln; {
...
resit:		s = resolveid( s, thisln, gflg );
		if( gflg || globst == nilst || globst == nest ) goto ret;
...
char *
expr( s, thisln, gflg ) reg char *s; reg LN *thisln; {
...
char *
xlate( s, thisln ) reg char *s; reg LN *thisln; {
...
doline( s, thisln ) reg char *s; reg LN *thisln; {
...
among( ch, strings ) reg ch; reg char *strings; {
...
setout(s) reg char *s; {		/* reset output */
